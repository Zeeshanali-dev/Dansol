  ...
  return (
    <>
      <nav className="bg-gray-950 w-full text-white px-4 md:px-16 py-4 flex justify-between relative">
        ...
        <div>
          <ul
            className={`md:flex  mr-3 absolute md:static bg-gray-500 md:bg-inherit h-screen md:h-auto z-10 min-w-52 top-[65px] ${
          ...
          >
            <li>
              <a
                href="#"
                className="px-3 py-2 hover:bg-blue-500 rounded-md relative"
                onClick={closed}
              >
                Home
              </a>
