              ...
              <Container>
                  <div className='px-1 flex justify-between  w-full'>
                      <div className='flex items-center py-4 min-w-[270px]'>
                          ...
                          <span className='cursor-pointer ml-4 hover:rotate-180 transition-all duration-300'><img src={down_arrow} alt="" /></span>
                      </div>
                      <div className='flex items-center lg:border-r lg:border-l border-gray-600 relative w-auto lg:w-[50%]'>
                          <input type="text" name="" id="" placeholder='write something here...' className='outline-none border-none pl-6 pr-8 relative w-full' />
                      ...
                      <div className='py-4 hidden lg:flex items-center ml-[9rem] '>
                          <span className='mr-10'><img src={heart} alt="" /></span>
                          
                          <span className='mr-10'>
                              <Link to='/cart'><img src={shopping_cart} alt="" /></Link>
                          </span>
                          
                          <span className=''><img src={user} alt="" /></span>
                      </div>
                  </div>
              </Container>
         </div> 
